...
math_obj math_obj_eval_plus(math_obj self) {
...
math_obj math_obj_eval_product(math_obj self) {
    int childCount = len(self->children);
...
math_obj math_obj_eval(math_obj self) {
    ...
    if (childCount == 0) {
        ...
        {
        case NEGATE:
            return math_obj_eval_negate(self);        
        default:
            assert(false);
            break;
        }
        ...
        case EQUATION:
            return self;
        case PLUS: 
            return math_obj_eval_plus(self);
        case PRODUCT:
            return math_obj_eval_product(self);
        case FRACTION:
